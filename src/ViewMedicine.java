...
public class ViewMedicine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(824, 6, 20, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Medicine ID", "Name", "Manufacturer", "Quantity", "Price Per Unit"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 76, 838, 382));
        ...
        int a = JOptionPane.showConfirmDialog(null, "Do you want to delete this medicine?","Select",JOptionPane.YES_NO_OPTION);
            if(a==0){
                try{
                    ...
                    ps.setString(1,id);
                    ps.executeUpdate();
                    JOptionPane.showMessageDialog(null, "Medicine sucessfully Deleted");
                    setVisible(false);
